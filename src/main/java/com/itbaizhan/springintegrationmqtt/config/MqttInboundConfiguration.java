...
import com.itbaizhan.springintegrationmqtt.handler.ReceiverMessageHandler;
...
public class MqttInboundConfiguration {
    ...
    // 消息通道
    @Bean
    public MessageChannel messageInboundChanel(){
    ...
    public MessageProducer messageProducer(){
        ...
        mqttPahoMessageDrivenChannelAdapter.setOutputChannel(messageInboundChanel());

        return mqttPahoMessageDrivenChannelAdapter;
    }

    @Bean
    @ServiceActivator(inputChannel = "messageInboundChanel")
